 ...
 */
const PortalManager: React.RefForwardingComponent<PortalManagerMethods, {}> = (_, ref): any => {
  ...
  React.useImperativeHandle(
    ...
    (): PortalManagerMethods => ({
      mount: (key: number, children: React.ReactNode) => setPortals((portals) => [...portals, { key, children }]),
      ...
      unmount: (key: number) => setPortals((portals) => portals.filter((item) => item.key !== key)),
    }),
  );
